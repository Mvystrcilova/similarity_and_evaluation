...
for j in range(5):
    evaluation = Evaluation('mnt/0/distances/som_w2v_3g3i.npy', 'mnt/0/useful_playlists', 'mnt/0/useful_songs', False, threshold=0.9567)
    ...
    for user in evaluation.users:
        ...
        i = i + 1
    filename = 'mnt/0/results/som_w2v_results/chopped_som_w2v_' + str(j+1)
    print(results.shape)
