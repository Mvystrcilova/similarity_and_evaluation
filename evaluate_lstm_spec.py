...
for j in range(5):
    evaluation = Evaluation('/mnt/0/short_LSTM_spec_distances.npy', '/mnt/0/useful_playlists', 'mnt/0/useful_songs', False, threshold=0.9759203838433013)
    ...
    for user in evaluation.users:
        ...
        i = i + 1
    filename = '/mnt/0/results/short_LSTM_spec_results/chopped_LSTM_spec_' + str(j+1)
    print(results.shape)
