...
for j in range(5):
    evaluation = Evaluation('mnt/0/pca_spec_distances_1106.npy', 'mnt/0/useful_playlists', 'mnt/0/useful_songs', False, threshold=0.337)
    ...
    for user in evaluation.users:
        ...
        i = i + 1
    filename = 'mnt/0/results/pca_spec_results_1106/chopped_pca_spec_' + str(j+1)
    print(results.shape)
