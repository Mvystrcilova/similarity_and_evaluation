...
for j in range(5):
    evaluation = Evaluation('mnt/0/pca_melspectrogram_distances.npy', 'mnt/0/useful_playlists', 'mnt/0/useful_songs', False, threshold=0.383)
    ...
    for user in evaluation.users:
        ...
        i = i + 1
    filename = 'mnt/0/results/pca_mel_results/chopped_pca_mel_threshold_0.383_' + str(j+1)
    print(results.shape)
