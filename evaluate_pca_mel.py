...
for j in range(5):
    evaluation = Evaluation('mnt/0/pca_mel_distances_5717.npy', 'mnt/0/useful_playlists', 'mnt/0/useful_songs', False, threshold=0.19)
    ...
    for user in evaluation.users:
        ...
        i = i + 1
    filename = 'mnt/0/results/pca_mel_results_5717/chopped_pca_mel_' + str(j+1)
    print(results.shape)
