...
for j in range(5):
    evaluation = Evaluation('mnt/0/gru_mfcc_distances.npy', 'mnt/0/useful_playlists', 'mnt/0/useful_songs', False, threshold=0.9530696952108149)
    ...
    for user in evaluation.users:
        ...
        i = i + 1
    filename = 'mnt/0/results/gru_mfcc_results/chopped_gru_mfcc_' + str(j+1)
    print(results.shape)
