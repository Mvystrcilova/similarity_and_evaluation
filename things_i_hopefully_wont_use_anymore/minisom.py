...
class MiniSom(object):
    def __init__(self, x, y, som_model_name, input_len, sigma=1.0, learning_rate=0.5,
        ...
        self.som_model_name = som_model_name
    ...
    def update(self, x, win, t, max_iteration):
        ...
        if (t % 16594 == 0) and (t != 0):
            with open(self.som_model_name + str(t), 'wb') as outfile:
