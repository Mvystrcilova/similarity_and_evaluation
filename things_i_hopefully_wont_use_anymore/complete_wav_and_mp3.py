...
import pandas
from audio_representations import convert_files_to_mels_and_mfccs
import string
...
def clean_mp3_list_on_mac():
    mp3_list = pandas.read_csv('/Users/m_vys/PycharmProjects/similarity_and_evaluation/mp3_on_mac.txt', sep=';', header = None, index_col=False)
    mp3_i_need = pandas.read_csv('/Users/m_vys/PycharmProjects/similarity_and_evaluation/song_paths', sep=';', header=None, index_col=False)

    missing_mp3s = mp3_i_need.merge(mp3_list, how='inner', )
