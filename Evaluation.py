...
for j in range(5):
    evaluation = Evaluation('distances/final_lstm_mel_distances.npy', 'useful_playlists', 'useful_songs')
...
for j in range(5):
    evaluation = Evaluation('distances/final_gru_mel_distances.npy', 'useful_playlists', 'useful_songs')
...
for j in range(5):
    evaluation = Evaluation('distances/final_gru_spec_distances.npy', 'useful_playlists', 'useful_songs')
    results = pandas.DataFrame(columns=['playlist_lenght', 'test_list_lenght', 'number_of_matches', 'match_ranking', 'recall_at_10',
                 'recall_at_50', 'recall_at_100', 'nDGC'])
    i = 0
    for user in evaluation.users:
