...
print(get_threshold_at((829700), 'mnt/0/new_distances/gru_mfcc_distances_30_32.npy'))
print(get_threshold_at((829700), 'mnt/0/new_distances/gru_mfcc_distances_30_64.npy'))
